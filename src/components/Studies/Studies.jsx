            ...
            <div className='infoEducation'>
                {language === "EN" ?
                    <>
                        ...
                        <p><strong>2022-2023</strong> Full Stack carreer at <a href="https://www.coderhouse.com/">CoderHouse</a>. Web development, JavaScript & ReactJS finished.</p>
                        <p>My Back-End habilities were self-taught, but I'm also studying Back-end in CoderHouse to polish details and improve my knowledge.</p>
                    </>
                    :
                    <>
                        <p>
                        ...
                        <p><strong>2022-2023</strong> Carrera Full Stack en <a href="https://www.coderhouse.com/">CoderHouse</a>. Desarrollo web, JavaScript & ReactJS terminado.</p>
                        <p>Mis habilidades de Back-End fueron adquiridas de manera autodidacta, sin embargo ya estoy en cursada de Back-End en CoderHouse para pulir detalles y ampliar mi conocimiento.</p>
                    </>}
